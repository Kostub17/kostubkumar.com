              ...
              <div>
                <div className="grid sm:grid-cols-2 gap-6 mb-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-neutral-800 border text-white rounded-lg focus:outline-none transition-all ${
                        focusedField === 'name' ? 'border-gray-500 ring-2 ring-gray-500/20' : 'border-neutral-700'
                      }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      className={`w-full px-4 py-3 bg-neutral-800 border text-white rounded-lg focus:outline-none transition-all ${
                        focusedField === 'email' ? 'border-gray-500 ring-2 ring-gray-500/20' : 'border-neutral-700'
                      }`}
                ...
                <div className="mb-6">
                  ...
                  <input
                    ...
                    required
                    className={`w-full px-4 py-3 bg-neutral-800 border text-white rounded-lg focus:outline-none transition-all ${
                      focusedField === 'subject' ? 'border-gray-500 ring-2 ring-gray-500/20' : 'border-neutral-700'
                    }`}
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    className={`w-full px-4 py-3 bg-neutral-800 border text-white rounded-lg focus:outline-none resize-none transition-all ${
                      focusedField === 'message' ? 'border-gray-500 ring-2 ring-gray-500/20' : 'border-neutral-700'
                    }`}
                ...
                <motion.button
                  type="submit"
                  className="w-full sm:w-auto px-8 py-3 bg-gray-700 text-white rounded-lg hover:bg-gray-600 transition-all flex items-center justify-center gap-2"
                  whileTap={{ scale: 0.95 }}
                >
                  <Send size={18} />
                  Send Message
            ...
            <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6">
              ...
              <div className="space-y-4">
                <motion.div
                  ...
                  whileHover={{ x: 5 }}
                >
                  <div className="p-2 bg-gradient-to-br from-gray-950 to-gray-900 rounded-lg border border-gray-800">
            ...
            <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6">
              ...
              <div className="space-y-3">
                <motion.a
                  ...
                  className="flex items-center gap-3 p-3 bg-neutral-900 border border-neutral-800 rounded-lg hover:border-gray-600 transition-all"
                >
