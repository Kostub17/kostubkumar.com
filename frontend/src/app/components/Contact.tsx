import { Mail, Phone, MapPin, Send, Github, Linkedin, Twitter, MessageCircle, Clock, CheckCircle2 } from 'lucide-react';
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-4 text-center">
            <Clock className="text-neutral-400 mx-auto mb-2" size={24} />
            <div className="text-white font-semibold">24h</div>
            <div className="text-neutral-400 text-xs">Response Time</div>
          </div>
          <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-4 text-center">
            <MessageCircle className="text-neutral-400 mx-auto mb-2" size={24} />
            <div className="text-white font-semibold">500+</div>
            <div className="text-neutral-400 text-xs">Messages</div>
          </div>
          <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-4 text-center">
            <CheckCircle2 className="text-neutral-400 mx-auto mb-2" size={24} />
            <div className="text-white font-semibold">100%</div>
            <div className="text-neutral-400 text-xs">Satisfaction</div>
          </div>
        </motion.div>
            ...
            <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6">
              ...
              <div className="space-y-3">
                ...
                <motion.a
                  ...
                  className="flex items-center gap-3 p-3 bg-neutral-800 border border-neutral-700 rounded-lg hover:border-neutral-600 transition-all"
                >
                  <Twitter className="text-neutral-400" size={24} />
